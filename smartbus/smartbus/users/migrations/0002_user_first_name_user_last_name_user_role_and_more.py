# Generated by Django 5.2.9 on 2026-01-01 05:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='role',
            field=models.CharField(choices=[('Bus operator', 'Bus operator'), ('Passengers', 'Passengers')], default='Admin'),
        ),
        ...
        migrations.AlterField(
            model_name='user',
            name='password',
            field=models.CharField(unique=True, verbose_name='User Password'),
        ),
        migrations.AlterField(
            model_name='user',
            name='username',
